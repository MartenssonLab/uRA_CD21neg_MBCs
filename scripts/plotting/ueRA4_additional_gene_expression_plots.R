...
#---PCs and Other Genes---#
DoHeatmap(ueRA4.1, features = c("PRDM1", "IRF4", "XBP1", "IL6R", "CD79A", "SYK", 
...
DoHeatmap(ueRA4.1, features = c("HLA-DRA", "HLA-DRB1", "HLA-DRB5", "HLA-DPA1", "HLA-DPB1", 
...
genes = read.xlsx("reports/ueRA4_3.1_vs_3.0_DEGs.xlsx", 
	sheetName = "DEGs", col.names = TRUE, row.names = FALSE)	

DoHeatmap(ueRA4.1, features = genes$gene, raster = FALSE, 
