...
vdj_doublets = read.table("data/VDJ_data/ueRA1_VDJ-seq_doublets.txt", header = FALSE, row.names = NULL) # Read in list of VDJ-seq doublets
Idents(object = ueRA1, cells = vdj_doublets) = "VDJDubs" # Indicate VDJ-seq data doublets
...
write.xlsx(pos.marks, "data/ueRA1_DEGs.xlsx", sheetName = "Upregulated", col.names = TRUE, row.names = FALSE)
write.xlsx(neg.marks, "data/ueRA1_DEGs.xlsx", sheetName = "Downregulated", col.names = TRUE, row.names = FALSE, append = TRUE)
